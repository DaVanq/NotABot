...
class General:
    ...
    async def ping(self):
        """Pong! :ping_pong: (do pingt for actual psuedo-ping!)"""
    ...
    async def choose(self, *choices):
        ...
        if len(choices) < 2:
            await self.bot.say('Erm...Not enough choices to pick from.')
        else:
    ...
    async def rps(self, ctx, your_choice : RPSParser):
        ...
        if outcome is True:
            await self.bot.say("{} Dangit... you win :sob: {}!"
                               "".format(red_choice.value, author.mention))
        elif outcome is False:
            await self.bot.say("{} YES! You lose!!! :joy: {}!"
                               "".format(red_choice.value, author.mention))
        else:
            await self.bot.say("{} Uh.. We're square I guess :thinking: {}!"
                               "".format(red_choice.value, author.mention))
    ...
    async def _8ball(self, *, question : str):
        ...
        if question.endswith("?") and question != "?":
            ...
            await self.bot.say("Huh. That doesn't look like a question. Try adding a question mark")
    ...
    async def stopwatch(self, ctx):
        ...
        if not author.id in self.stopwatches:
            ...
            await self.bot.say(author.mention + " Rolex stopwatch started!")
        else:
            tmp = abs(self.stopwatches[author.id] - int(time.perf_counter()))
            tmp = str(datetime.timedelta(seconds=tmp))
            await self.bot.say(author.mention + " Rolex stopwatch stopped! Time: **" + tmp + "**")
    ...
    async def serverinfo(self, ctx):
        ...
        created_at = ("Woah! Since {}. That's over {} days ago!"
    ...
    async def urban(self, *, search_terms : str, definition_number : int=1):
        ...
        try:
            ...
            if result["list"]:
                ...
                await self.bot.say("Dangit...Your search terms gave no results.")
        except IndexError:
    ...
    async def poll(self, ctx, *text):
        ...
        if not self.getPollByChannel(message):
            ...
            if "@everyone" in check or "@here" in check:
                await self.bot.say("Nice try. :face_palm:")
                return
    ...
    async def endpoll(self, message):
        if self.getPollByChannel(message):
            ...
            if p.author == message.author.id: # or isMemberAdmin(message)
                ...
                await self.bot.say("Only admins and the author can stop dis poll.")
        else:
            await self.bot.say("There's no poll ongoing in this channel. Start one!")
